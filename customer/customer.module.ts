...
import { ExchangeProductDetailsComponent } from './customer-home/view-all-products/exchange-product/exchange-product-details/exchange-product-details.component';
...
@NgModule({
    declarations: [
        ...
        CustomerProductDetails,
        ExchangeProductDetailsComponent
    ],
    imports: [
        BrowserModule,
        FormsModule,
