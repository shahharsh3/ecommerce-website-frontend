...
export class ViewAllProductsService {
  ...
  getAllExchangeProduct(): Observable<Exchange[]>{
    let url = environment.CustomerProductAPI + "/getAllExchangeProduct";

    return this.http.get<Exchange[]>(url).pipe(catchError(this.handleError));
  }
